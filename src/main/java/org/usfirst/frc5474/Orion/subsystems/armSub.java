...
public class armSub extends Subsystem {
    ...
    public armSub() {
        ...
        hingeMotor = new Talon(5); //don't know talon address, 5 isn't correct
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new setPosition(1.0, false)); //1.0 just giving it a parameter, not important
    ...
    public void armDirection(double armPos){
        ...
        public void moveArmToPosition(double armPos, boolean clawHorizontal){
        double currentArmPos=armEncoder.getDistance(); 
        if(goingUp==true){
            if(currentArmPos<armPos){
                armMotor.set(.2);
        ...
        //derek add get hinge position when we are ready to swing
