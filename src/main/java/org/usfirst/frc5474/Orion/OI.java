...
public class OI {
    ...
    public OI() {
        ...
        setPosBall3.whenPressed(new setPosition(7.0, dropAngleVal)); //probably is not correct level for ball 3, but maybe
        setPosHatch3 = new JoystickButton(proJoystick, 7);
        setPosHatch3.whenPressed(new setPosition(6.0, dropAngleVal));
        setPosBall2 = new JoystickButton(proJoystick, 10);
        setPosBall2.whenPressed(new setPosition(5.0, dropAngleVal));
        setPosHatch2 = new JoystickButton(proJoystick, 9);
        setPosHatch2.whenPressed(new setPosition(4.0, dropAngleVal));
        setPosBall1 = new JoystickButton(proJoystick, 12);
        setPosBall1.whenPressed(new setPosition(3.0, dropAngleVal));
