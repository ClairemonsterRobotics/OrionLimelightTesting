...
public class OI {
    ...
    public OI() {
        ...
        setPosBall3.whenPressed(new setPosition(7.0, false));
        setPosHatch3 = new JoystickButton(proJoystick, 7);
        setPosHatch3.whenPressed(new setPosition(6.0, false));
        setPosBall2 = new JoystickButton(proJoystick, 10);
        setPosBall2.whenPressed(new setPosition(5.0, false));
        setPosHatch2 = new JoystickButton(proJoystick, 9);
        setPosHatch2.whenPressed(new setPosition(4.0, false));
        setPosBall1 = new JoystickButton(proJoystick, 12);
        setPosBall1.whenPressed(new setPosition(3.0, false));
        setPosHatch1 = new JoystickButton(proJoystick, 11);
        setPosHatch1.whenPressed(new setPosition(2.0, false));
        setPosBottom = new JoystickButton(proJoystick, 3);
        setPosBottom.whenPressed(new setPosition(1.0, true));        
