...
public class OI {
    ...
    public OI() {
        ...
        setPosBall3.whenPressed(new setPosition(1.2));
        setPosHatch3 = new JoystickButton(proJoystick, 7);
        setPosHatch3.whenPressed(new setPosition(1.0));
        setPosBall2 = new JoystickButton(proJoystick, 10);
        setPosBall2.whenPressed(new setPosition(.8));
        setPosHatch2 = new JoystickButton(proJoystick, 9);
        setPosHatch2.whenPressed(new setPosition(0.6));
        ...
        setPosHatch1.whenPressed(new setPosition(0.2));
