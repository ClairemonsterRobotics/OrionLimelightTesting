...
public class openClaw extends Command {
    ...
    protected void initialize() {
        ...
        timer = new Timer();
        timer.start();
        Robot.pClawSub.pistonRetract(); //retraction = claw opens
    }

    // Called repeatedly when this Command is scheduled to run
    @Override
    protected void execute() {
        //boolean retractActivated = false;
        //SmartDashboard.putNumber("open claw Timer", timer.get());
        if (timer.get() >= 0.2) {
