...
public boolean localClawHorizontal;
    ...
    public setPosition(double armPos, boolean clawHorizontal) {
localArmPos=armPos;
localClawHorizontal=clawHorizontal;
    ...
    @Override
    protected void initialize() {Robot.armSub.armDirection(localArmPos);
        
    }

    // Called repeatedly when this Command is scheduled to run
    @Override
    protected void execute() {Robot.armSub.moveArmToPosition(localArmPos, localClawHorizontal);
