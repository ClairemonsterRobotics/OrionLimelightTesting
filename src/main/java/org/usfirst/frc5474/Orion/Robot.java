...
public class Robot extends TimedRobot {
    ...
    public static pClawSub pClawSub;
    ...
    public void robotInit() {
        ...
        chooser.addOption("AutonomousLeft", new AutonomousLeft());
        chooser.addOption("AutonomousRight", new AutonomousRight());
        chooser.addOption("AutonomousCenter", new AutonomousCenter());
        chooser.addOption("Manual Mode", new arcadeDrive());
        chooser.setDefaultOption("Manual Arcade Drive", new arcadeDrive());
