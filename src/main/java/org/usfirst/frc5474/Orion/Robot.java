...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        chooser.addOption("AutonomousLeft", new AutonomousSide(true));
        chooser.addOption("AutonomousRight", new AutonomousSide(false));
        chooser.addOption("AutonomousCenter", new AutonomousCenter());
        chooser.setDefaultOption("AutonomousCenter", new AutonomousCenter());
